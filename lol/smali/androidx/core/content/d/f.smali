...
.method private static a(Landroidx/core/content/d/f$b;ILandroid/content/res/ColorStateList;)V
    .locals 3
    .param p0    # Landroidx/core/content/d/f$b;
...
.method public static c(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Landroidx/core/content/d/f;->g(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
...
.method public static e(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/d/f$c;)Landroid/graphics/Typeface;
    .locals 8
    ...
    invoke-static/range {v0 .. v7}, Landroidx/core/content/d/f;->i(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method private static g(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, p1}, Landroidx/core/content/d/f;->h(Landroid/content/res/Resources;I)Z
...
.method private static h(Landroid/content/res/Resources;I)Z
    ...
    invoke-static {}, Landroidx/core/content/d/f;->f()Landroid/util/TypedValue;
...
.method private static i(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 10
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static/range {v0 .. v8}, Landroidx/core/content/d/f;->j(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method private static j(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 15
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
