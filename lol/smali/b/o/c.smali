...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Lb/o/c;->b:Ljava/io/File;

    iput-object p2, p0, Lb/o/c;->d:Ljava/io/File;

    invoke-static {p1}, Lb/o/c;->G(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Lb/o/c;->c:J
    ...
    iput-object p2, p0, Lb/o/c;->e:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Lb/o/c;->f:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Lb/o/c;->g:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, Lb/o/c;->f:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, Lb/o/c;->p(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, Lb/o/c;->e:Ljava/io/RandomAccessFile;
...
.method private static G(Ljava/io/File;)J
    ...
    invoke-static {p0}, Lb/o/d;->c(Ljava/io/File;)J
...
.method private static I(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p0}, Lb/o/c;->w(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p1}, Lb/o/c;->A(Ljava/io/File;)J
...
.method private N(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 16
    ...
    iget-object v3, v0, Lb/o/c;->b:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Lb/o/c;->w(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, Lb/o/c$b;

    iget-object v9, v0, Lb/o/c;->d:Ljava/io/File;

    invoke-direct {v8, v9, v7}, Lb/o/c$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lb/o/c;->G(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Lb/o/c$b;->b:J
...
.method private T()Ljava/util/List;
    ...
    iget-object v6, v1, Lb/o/c;->b:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, Lb/o/c;->k()V
    ...
    iget-object v0, v1, Lb/o/c;->b:Ljava/io/File;
    ...
    new-instance v11, Lb/o/c$b;

    iget-object v12, v1, Lb/o/c;->d:Ljava/io/File;

    invoke-direct {v11, v12, v0}, Lb/o/c$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v10, v11, v6}, Lb/o/c;->r(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Lb/o/c;->G(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Lb/o/c$b;->b:J
    :try_end_1
    ...
    iget-wide v12, v11, Lb/o/c$b;->b:J
...
.method private k()V
    ...
    iget-object v0, p0, Lb/o/c;->d:Ljava/io/File;

    new-instance v1, Lb/o/c$a;

    invoke-direct {v1, p0}, Lb/o/c$a;-><init>(Lb/o/c;)V
    ...
    iget-object v2, p0, Lb/o/c;->d:Ljava/io/File;
...
.method private static r(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    .locals 5
    ...
    invoke-static {p0}, Lb/o/c;->p(Ljava/io/Closeable;)V
...
.method private static w(Landroid/content/Context;)Landroid/content/SharedPreferences;
    .locals 2
...
# virtual methods
.method M(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lb/o/c;->b:Ljava/io/File;
    ...
    iget-object v0, p0, Lb/o/c;->g:Ljava/nio/channels/FileLock;
    ...
    iget-object v0, p0, Lb/o/c;->b:Ljava/io/File;

    iget-wide v2, p0, Lb/o/c;->c:J

    invoke-static {p1, v0, v2, v3, p2}, Lb/o/c;->I(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lb/o/c;->N(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_1
    invoke-direct {p0}, Lb/o/c;->T()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Lb/o/c;->b:Ljava/io/File;

    invoke-static {v0}, Lb/o/c;->A(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Lb/o/c;->c:J
    ...
    invoke-static/range {v2 .. v8}, Lb/o/c;->W(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public close()V
    ...
    iget-object v0, p0, Lb/o/c;->f:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    iget-object v0, p0, Lb/o/c;->e:Ljava/io/RandomAccessFile;
