...
.method final a()Z
    ...
    invoke-static {v0, v1}, Lcom/google/firebase/messaging/e;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v3}, Lcom/google/firebase/messaging/e;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lcom/google/firebase/messaging/g;->r(Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual {v3, v4}, Lcom/google/firebase/messaging/e;->k(Landroid/os/Bundle;)Lcom/google/firebase/messaging/d;

    move-result-object v3

    iget-object v4, v3, Lcom/google/firebase/messaging/d;->a:Landroidx/core/app/i$e;
    ...
    :try_start_0
    invoke-virtual {v0}, Lcom/google/firebase/messaging/g;->k()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {v4, v6}, Landroidx/core/app/i$e;->t(Landroid/graphics/Bitmap;)Landroidx/core/app/i$e;

    new-instance v7, Landroidx/core/app/i$b;

    invoke-direct {v7}, Landroidx/core/app/i$b;-><init>()V

    invoke-virtual {v7, v6}, Landroidx/core/app/i$b;->i(Landroid/graphics/Bitmap;)Landroidx/core/app/i$b;

    move-result-object v6

    const/4 v7, 0x0

    invoke-virtual {v6, v7}, Landroidx/core/app/i$b;->h(Landroid/graphics/Bitmap;)Landroidx/core/app/i$b;

    move-result-object v6

    invoke-virtual {v4, v6}, Landroidx/core/app/i$e;->B(Landroidx/core/app/i$h;)Landroidx/core/app/i$e;
    :try_end_0
    ...
    iget-object v3, v3, Lcom/google/firebase/messaging/d;->a:Landroidx/core/app/i$e;
