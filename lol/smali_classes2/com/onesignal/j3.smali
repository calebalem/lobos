.class Lcom/onesignal/j3;
.super Landroid/database/sqlite/SQLiteOpenHelper;
.source ""

# interfaces
.implements Lcom/onesignal/i3;
...
.field private static d:Lcom/onesignal/q1;

.field private static e:Lcom/onesignal/j3;

.field private static f:Lcom/onesignal/r4/a/k;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/onesignal/j3;->b:Ljava/lang/Object;
    ...
    sput-object v0, Lcom/onesignal/j3;->c:[Ljava/lang/String;

    new-instance v0, Lcom/onesignal/p1;

    invoke-direct {v0}, Lcom/onesignal/p1;-><init>()V

    sput-object v0, Lcom/onesignal/j3;->d:Lcom/onesignal/q1;

    new-instance v0, Lcom/onesignal/r4/a/k;

    invoke-direct {v0}, Lcom/onesignal/r4/a/k;-><init>()V

    sput-object v0, Lcom/onesignal/j3;->f:Lcom/onesignal/r4/a/k;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {}, Lcom/onesignal/j3;->G()I
...
.method private static F0(Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 1
    ...
    invoke-static {p0, v0}, Lcom/onesignal/j3;->Z(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
...
.method private static G0(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p0}, Lcom/onesignal/j3;->h0(Landroid/database/sqlite/SQLiteDatabase;)V

    return-void
.end method

.method private static H0(Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 1
...
.method public static I(Landroid/content/Context;)Lcom/onesignal/j3;
    .locals 2

    sget-object v0, Lcom/onesignal/j3;->e:Lcom/onesignal/j3;

    if-nez v0, :cond_1

    sget-object v0, Lcom/onesignal/j3;->b:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/onesignal/j3;->e:Lcom/onesignal/j3;

    if-nez v1, :cond_0

    new-instance v1, Lcom/onesignal/j3;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p0

    invoke-direct {v1, p0}, Lcom/onesignal/j3;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/onesignal/j3;->e:Lcom/onesignal/j3;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcom/onesignal/j3;->e:Lcom/onesignal/j3;
...
.method private I0(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    sget-object v0, Lcom/onesignal/j3;->f:Lcom/onesignal/r4/a/k;

    invoke-virtual {v0, p1}, Lcom/onesignal/r4/a/k;->c(Landroid/database/sqlite/SQLiteDatabase;)V

    sget-object v0, Lcom/onesignal/j3;->f:Lcom/onesignal/r4/a/k;

    invoke-virtual {v0, p1}, Lcom/onesignal/r4/a/k;->a(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method private N()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :goto_0
    :try_start_0
    invoke-direct {p0}, Lcom/onesignal/j3;->M()Landroid/database/sqlite/SQLiteDatabase;
...
.method private W(Landroid/database/sqlite/SQLiteDatabase;I)V
    ...
    invoke-static {p1}, Lcom/onesignal/j3;->m0(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p1}, Lcom/onesignal/j3;->z0(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p1}, Lcom/onesignal/j3;->F0(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p1}, Lcom/onesignal/j3;->G0(Landroid/database/sqlite/SQLiteDatabase;)V

    :cond_3
    if-ne p2, v0, :cond_4

    invoke-static {p1}, Lcom/onesignal/j3;->h0(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1}, Lcom/onesignal/j3;->I0(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method static Y()Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v2}, Lcom/onesignal/i2;->l()Z
...
.method private static h0(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-virtual {v0, p0}, Lcom/onesignal/r4/a/k;->b(Landroid/database/sqlite/SQLiteDatabase;)V

    return-void
.end method

.method private static m0(Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 1
...
.method private static z0(Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 1
...
.method public A(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)V
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/onesignal/j3;->N()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_3
    sget-object p2, Lcom/onesignal/j3;->d:Lcom/onesignal/q1;
    ...
    :try_start_4
    sget-object v3, Lcom/onesignal/j3;->d:Lcom/onesignal/q1;
    ...
    invoke-interface {v3, p1, v2}, Lcom/onesignal/q1;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_4
    ...
    :try_start_b
    sget-object p3, Lcom/onesignal/j3;->d:Lcom/onesignal/q1;

    const-string v1, "Error closing transaction! "

    :goto_3
    invoke-interface {p3, v1, p2}, Lcom/onesignal/q1;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public k(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    .locals 6
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :cond_0
    sget-object v1, Lcom/onesignal/j3;->b:Ljava/lang/Object;
    ...
    invoke-interface {v3, p1, p2}, Lcom/onesignal/q1;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    :goto_3
    invoke-interface {p3, p4, p2}, Lcom/onesignal/q1;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    sget-object v1, Lcom/onesignal/j3;->c:[Ljava/lang/String;
...
.method public onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    sget-object p2, Lcom/onesignal/c3$c0;->e:Lcom/onesignal/c3$c0;

    const-string p3, "SDK version rolled back! Clearing OneSignal.db as it could be in an unexpected state."

    invoke-static {p2, p3}, Lcom/onesignal/c3;->a(Lcom/onesignal/c3$c0;Ljava/lang/String;)V

    sget-object p2, Lcom/onesignal/j3;->b:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/onesignal/j3;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-static {v0, p3}, Lcom/onesignal/c3;->a(Lcom/onesignal/c3$c0;Ljava/lang/String;)V

    sget-object p3, Lcom/onesignal/j3;->b:Ljava/lang/Object;

    monitor-enter p3

    :try_start_0
    invoke-direct {p0, p1, p2}, Lcom/onesignal/j3;->W(Landroid/database/sqlite/SQLiteDatabase;I)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public p(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    .locals 11
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public r(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    .locals 10
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
