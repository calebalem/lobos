...
.method public static d()Ljava/util/Map;
    ...
    sget-object v0, Lkotlin/collections/w;->b:Lkotlin/collections/w;
...
.method public static varargs e([Lkotlin/Pair;)Ljava/util/HashMap;
    ...
    invoke-static {v0, p0}, Lkotlin/collections/c0;->j(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static varargs f([Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/c0;->n([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final h(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lkotlin/collections/b0;->c(Ljava/util/Map;)Ljava/util/Map;
...
.method public static k(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/c0;->l(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lkotlin/collections/z;->b(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/c0;->l(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/c0;->h(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final l(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/c0;->i(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static m(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lkotlin/collections/z;->o(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final n([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/c0;->j(Ljava/util/Map;[Lkotlin/Pair;)V
